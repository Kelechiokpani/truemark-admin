...
import { UPDATE_COURSE } from "@/lib/Mutation/mutation";
...
const Update_Course =({ onClose, isOpen, courseListing })=> {
  const [fileUrl, setFileUrl] = useState<string>("");
  const [CreateCourse, { loading, error }] = useMutation(UPDATE_COURSE, {
    ...
    <div
      ...
      <div className="px-2 pr-14">
        ...
        <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
          Update existing course for your audience.
        </p>
      </div>
